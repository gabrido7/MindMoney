  ...
  return (
    <div className="relative hidden h-full w-full overflow-hidden bg-neutral-950 lg:block">
      ...
      {BADGES.map(({ icon, className }) => (
        <div
          key={icon}
          className={`absolute flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-neutral-900/80 text-green-400 shadow-[0_0_25px_rgba(34,197,94,0.25)] backdrop-blur ${className}`}
        >
      ...
      <div className="relative flex h-full w-full items-center justify-center px-12">
        <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-neutral-900/90 p-6 shadow-2xl shadow-black/60">
          <p className="text-xs text-neutral-400">Score financeiro</p>
          <div className="mt-3 flex items-center gap-4">
            <div className="flex h-20 w-20 items-center justify-center rounded-full border-4 border-green-500 text-2xl font-bold text-green-400">
              87
            </div>
            <div className="flex-1">
              <p className="text-sm font-semibold text-white">Excelente</p>
          ...
          <div className="mt-6 border-t border-white/10 pt-4">
            <p className="text-xs text-neutral-400">Meta do mês: viagem</p>
            <div className="mt-2 flex items-center justify-between text-sm">
              <span className="font-semibold text-white">R$ 1.200 / R$ 1.500</span>
